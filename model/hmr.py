...
class HMR_ISO(nn.Module):
    ...
    def forward(self, x, init_pose=None, init_shape=None, init_cam=None, n_iter=3):
        ...
        pred_shape = init_shape
        pred_cam = init_cam
        pred_rotmat_ssl, pred_shape_ssl, pred_cam_ssl = self.ssl(init_pose, init_shape, init_cam, xf, n_iter,
                                                                 batch_size)
        pred_rotmat_fsl, pred_shape_fsl, pred_cam_fsl = self.fsl(init_pose, init_shape, init_cam, xf, n_iter,
                                                                 batch_size)
