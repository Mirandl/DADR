...
class VIBE(nn.Module):
    def __init__(
            ...
            bidirectional=False,
            use_residual=True,
            pretrained=osp.join('/home/neu307/liumeilin/datasets/vibe_data', 'spin_model_checkpoint.pth.tar'),
    ):
    ...
    def forward(self, input, need_feature=False, J_regressor=None):
        features = []
        # input size NTF
        # batch_size, seqlen = input.shape[:2]
        # batch_size, seqlen, nc, h, w = input.shape  # batch_size, seq_length, num_channels, size, size.
        seqlen=16
